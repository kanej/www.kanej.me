  ...
  {:kanej.me
   {;; :build contains parameters which are passed to the build
    :build {;; :watch-files contains a list of files to watch for
            ...
            ;; the templates.
            :triggers {:html [#"kanej/me/rendering.js"]}}
    ...
    :aspects {;; Add an aspect that uses the data renderer
              ...
              :development {:uri "/kanej.me-dev.html"
                            :name "Development"
                            :out-file "kanej.me-dev.js"
                            :main 'kanej/me.start
                            :logging? true
                            :order 3}
              :fresh {:uri "/fresh.html"
                      ...
                      :output-root :tools-public
                      :template "tooling.html"}
              :production {:uri "/kanej.me.html"
                           :name "Production"
                           :optimizations :advanced
                           :out-file "kanej.me.js"
                           :main 'kanej/me.start
                           :order 5
